# Vyriy F405 v2 Flight Controller

The Vyriy F405 v2 is a flight controller produced by [Vyriy](http://www.vyriy.ua/).

## Features

 - STM32F405 microcontroller
 - IMC42688 or BMI270 IMU
 - DPS280 barometer
 - SDCard
 - AT7456E OSD
 - 6 UARTs
...
![Vyriy F405 v2](Vyriy_F405_v2_Board_Top.JPG "Vyriy F405 v2")
![Vyriy F405 v2](Vyriy_F405_v2_Board_Bottom.JPG "Vyriy F405 v2")
...
The Vyriy F405 v2 supports OSD using OSD_TYPE 1 (MAX7456 driver).
...
The Vyriy F405 v2 supports up to 9 PWM outputs. The pads for motor output
...
The Vyriy F405 v2 does not have a builtin compass, but you can attach an external compass using I2C on the SDA and SCL pads.
